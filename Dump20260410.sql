...
INSERT INTO `Booking` 
(id, customerId, roomId, staffId, status, totalAmount, bookingDate, checkInDate, checkOutDate, expectedCheckOutDate, actualCheckOutDate)
VALUES
(1,1,1,1,'CHECKED_OUT',200000,NULL,NULL,NULL,NULL,NULL);
